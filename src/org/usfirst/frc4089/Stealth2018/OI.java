...
public class OI {
    ...
    public OI() {
      ...
      //if (driveJoystick.getName() == "Logitech Extreme 3D") {
          ...
          DisplaySensors = new JoystickButton(driveJoystick, Constants.kDisplaySensorsButtonJoystick);
      ...
      /*} else if (driveJoystick.getName() == "Bluetooth XINPUT compatible input device") {*/
          ...
          SpeedShiftDown = new JoystickButton(driveJoystick, Constants.kShiftDownButtonGamepad);
          SpeedShiftDown.whenReleased(new SpeedShiftDown());
          
          DisplaySensors = new JoystickButton(driveJoystick, Constants.kDisplaySensorsButtonGamepad);
          DisplaySensors.whileHeld(new DisplaySensors());
